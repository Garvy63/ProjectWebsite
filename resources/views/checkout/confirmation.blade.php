...
<head>
    ...
    <meta charset="UTF-8">
    <!-- Site Title -->
    <title>Karma Shop - Order Confirmation</title>
    <!-- CSS -->
                ...
                <div class="col-lg-4">
                    <div class="details_item">
                        ...
                        <ul class="list">
                            ...
                            <li><a href="#"><span>Payment method</span> : {{ $order->payment_method == 'check_payment' ? 'Check payments' : ucfirst($order->payment_method ?? 'Not specified') }}</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-4">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p>Flat rate: Rp {{ number_format($order->shipping_cost, 0, ',', '.') }}</p>
                                </td>
                            </tr>
                            <tr>
                                <td>
