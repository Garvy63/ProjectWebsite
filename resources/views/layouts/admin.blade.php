...
<head>
    ...
    <title>Dashboard Admin KARMA SHOP</title> <link rel="shortcut icon" type="image/png" href="{{ asset('admin_assets/assets/images/logos/favicon.png') }}" />
...
<body>
                    ...
                    <div class="navbar-collapse justify-content-end px-0" id="navbarNav">
                        <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
                            <li class="nav-item me-3">
                                <span class="fs-3 fw-semibold d-none d-lg-block">Halo, {{ Auth::user()->name }}!</span>
                            </li>
    ...
    <script src="{{ asset('admin_assets/assets/libs/apexcharts/dist/apexcharts.min.js') }}"></script>
